    ...
    <el-dialog v-model="visible" append-to-body title="选择用户" top="5vh" width="800px">
      <el-form ref="queryFormRef" :inline="true" :model="queryParams">
        <el-form-item label="用户名称" prop="userName">
          <el-input v-model="queryParams.userName" clearable placeholder="请输入用户名称" @blur="handleQuery"
                    @keyup.enter="handleQuery"/>
        </el-form-item>
        <el-form-item label="手机号码" prop="phonenumber">
          <el-input v-model="queryParams.phonenumber" clearable placeholder="请输入手机号码" @blur="handleQuery"
                    @keyup.enter="handleQuery"/>
        </el-form-item>
        <el-form-item>
      ...
      <el-row>
        <el-table ref="tableRef" :data="userList" height="260px" @row-click="clickRow"
