<template>
  <div class="p-2">
        ...
        <el-card shadow="hover">
          <el-form ref="queryFormRef" :inline="true" :model="queryParams">
            <el-form-item label="树节点名" prop="treeName">
              <el-input v-model="queryParams.treeName" clearable placeholder="请输入树节点名" style="width: 240px"
    ...
    <el-card shadow="hover">
      <template #header>
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button v-hasPermi="['demo:tree:add']" icon="Plus" plain type="primary" @click="handleAdd()">新增
            </el-button>
          </el-col>
          <el-col :span="1.5">
      ...
      >
        ...
        <el-table-column align="center" label="树节点名" prop="treeName"/>
        <el-table-column align="center" class-name="small-padding fixed-width" label="操作">
          <template #default="scope">
            <el-tooltip content="修改" placement="top">
              <el-button v-hasPermi="['demo:tree:edit']" icon="Edit" link type="primary"
                         @click="handleUpdate(scope.row)"/>
            </el-tooltip>
            <el-tooltip content="新增" placement="top">
              <el-button v-hasPermi="['demo:tree:add']" icon="Plus" link type="primary" @click="handleAdd(scope.row)"/>
            </el-tooltip>
            <el-tooltip content="删除" placement="top">
              <el-button v-hasPermi="['demo:tree:remove']" icon="Delete" link type="primary"
    ...
    <el-drawer v-model="dialog.visible" :title="dialog.title" append-to-body size="30%">
      <el-form ref="treeFormRef" :model="form" :rules="rules" label-width="25%">
...
<script lang="ts" name="Tree" setup>
